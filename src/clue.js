...
const mrGreen = {
    ...
    image: 'https://66.media.tumblr.com/ee7155882178f73b3781603f0908617c/tumblr_phhxc7EhPJ1w5fh03_54.jpg',
    color: 'purple'
    }
    ...
    const weaponCandlestick= {
      name: 'candlestick',
      weight: 2
    }
    const weaponDumbbell ={
      name: 'dumbbell',
      weight: 30
    }
    const weaponPoison ={
    ...
    // Weapons Collection
    const weaponsArray = [weaponRope, weaponKnife, weaponCandlestick, weaponDumbbell];
